/* VKVTT v66.5 — premium shell bootstrap. Staff/category controller loads last. */
(function(){
'use strict';
...
function loadAuthoritativeStaffHome(){if(document.getElementById('v665StaffHomeScript'))return;const s=document.createElement('script');s.id='v665StaffHomeScript';s.src='v66-staff-home-v665.js?v=66.5-staff-home-2';s.defer=true;document.body.appendChild(s)}
...
window.addEventListener('load',()=>setTimeout(loadAuthoritativeStaffHome,800),{once:true});
setTimeout(loadAuthoritativeStaffHome,2200);
})();
