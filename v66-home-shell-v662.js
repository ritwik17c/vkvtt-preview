/* VKVTT v66.6 — premium shell + safe one-time staff identity */
(function(){
  'use strict';
  ...
  function loadStaffOnce(){if(document.getElementById('v666StaffIdentityOnce'))return;const s=document.createElement('script');s.id='v666StaffIdentityOnce';s.src='v66-staff-identity-once.js?v=66.6-safe-once-1';s.defer=true;document.body.appendChild(s);}
  ...
  window.addEventListener('load',()=>setTimeout(loadStaffOnce,1200),{once:true});
})();