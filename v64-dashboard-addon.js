...
(() => {
  ...
  function install(){
    ...
    if(!document.getElementById('v663StaffManagementTile')){
      ...
      staff.innerHTML='<b>👥 Staff Management</b><span>Timetable-safe staff directory with Employee Code, optional Teacher Short Name, separate Academic / Professional Qualifications, service details, inactive archive access and full extended Excel round-trip import/export.</span>';
      ...
      staff.onclick=()=>location.href='admin-staff-management-v7.html?v=66.3-inactive-archive-fix-2';
    }
